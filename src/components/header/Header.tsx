  ...
  return (
    <div className="fixed top-0 left-0 right-0 h-14 bg-white shadow-sm flex items-center justify-between px-4 z-50">
      ...
      <div className="flex items-center gap-2 w-1/4">
        {/* TRICK A4IF Logo */}
        <div className="w-10 h-10 bg-facebook-blue rounded-full flex items-center justify-center text-white font-bold text-xl cursor-pointer shadow-sm">
          TA
        </div>
      ...
      <div className="hidden lg:flex items-center justify-center gap-2 w-2/4">
        <div className="px-10 py-2 cursor-pointer border-b-4 border-facebook-blue text-facebook-blue rounded-md hover:bg-gray-100 transition-colors">
          <Home size={28} />
        </div>
      ...
      <div className="flex items-center justify-end gap-2 w-1/4">
        ...
        <div className="relative group cursor-pointer ml-2">
          ...
          <div className="absolute right-0 top-11 bg-white shadow-lg rounded-lg w-48 hidden group-hover:block border border-gray-100">
            ...
            <div className="p-2">
              <button onClick={handleLogout} className="flex items-center gap-2 w-full p-2 hover:bg-gray-100 rounded-md text-left text-sm font-semibold">
